...
public class LoginStepDefinition {
	...
	public void user_enters_and_password(DataTable credentials) {
		 List<List<String>> data = credentials.asLists(); 
		 //System.out.println(data.get(1).get(0));
		driver.findElement(By.name("Email Address")).sendKeys(data.get(0).get(0));
	...
	@Then("user moves to My Prodcuts Page$")
		public void user_moves_to_My_Prodcuts_Page() throws InterruptedException {
	...
	public void user_clicks_on_Redeem_Voucher_link() throws InterruptedException {
		Thread.sleep(4000);
	...
	public void user_enters_voucher(DataTable code) throws InterruptedException {
		List<List<String>> data = code.asLists(); 
		driver.findElement(By.xpath("//input[@id='PrestoVoucherCode']")).sendKeys(data.get(0).get(0));
		driver.findElement(By.xpath("//button[contains(text(),'CONTINUE TO REDEEM')]")).click();
		Thread.sleep(3000);
